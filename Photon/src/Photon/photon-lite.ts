...
module Photon.Lite {
    ...
    export class LitePeer extends PhotonPeer {
        ...
        */
        public join(roomName: string, roomProperties?: any, actorProperties?: any , broadcast?: bool) {
        ...
        */
        public setActorProperties(actorNr: number, data: any, broadcast: bool) {
            if (this.isJoined) {
        ...
        */
        ...
        /** 
            ...
            @param {bool} broadcast Triggers an LiteEventCode.PropertiesChanged event if true.
        */
        public setRoomProperties(data: any, broadcast: bool) {
            if (this.isJoined) {
        ...
        */
        ...
        private actors = {};
        private _myActor = { photonId: null, properties: {} };
        ...
        private _parseEvent(code: number, event: any) {
        ...
        private _parseResponse(code: number, response: any) {

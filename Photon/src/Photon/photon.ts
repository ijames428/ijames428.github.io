...
module Photon {
    ...
    export class PhotonPeer {
        ...
        */
        public sendOperation(code: number, data? :any, sendReliable: bool = false, channelId: number = 0) {
        ...
        */
        ...
        private _send(data: any, checkConnected: bool = false) {
...
module Exitgames.Common {
    export class Logger {
        ...
        */
        ...
        static private log_types = ["debug", "debug", "info", "warn", "error"]; 
